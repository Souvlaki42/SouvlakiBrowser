...
from PySide6.QtWidgets import (QMainWindow, QFileDialog,
                               ...
                               QProgressBar, QToolBar, QVBoxLayout, QWidget, QApplication)
...
class BrowserWindow(QMainWindow):
  ...
  def create_tool_bar(self):
    ...
    downloads_action.setIcon(QIcon(Config["GO_BOTTOM"]))
  ...
  def handle_web_view_title_changed(self, title):
    ...
    suffix = (f"{Config["APP_NAME"]} (Incognito)" if off_the_record
    ...
    if off_the_record:
      self.setWindowIcon(QIcon(Config["NINJA_LOGO"]))
